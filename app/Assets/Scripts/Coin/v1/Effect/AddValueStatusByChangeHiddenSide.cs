...
{
    class AddValueStatusByChangeHiddenSide : AddValueStatusBy
    {
        public AddValueStatusByChangeHiddenSide(
            int value,
            bool bCoinOwner)
            : base(value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AddValueStatusByChangeHiddenSide), format, param);
            }
        }
