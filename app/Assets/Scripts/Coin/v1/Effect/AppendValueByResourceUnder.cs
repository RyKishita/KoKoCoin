...
{
    class AppendValueByResourceUnder : AppendValueByCount
    {
        public AppendValueByResourceUnder(bool bCoinOwner, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByResourceUnder), formatType, param);
            }
        }
