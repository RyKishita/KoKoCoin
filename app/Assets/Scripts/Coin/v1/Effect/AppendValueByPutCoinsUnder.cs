...
{
    class AppendValueByPutCoinsUnder : AppendValueByCount
    {
        public AppendValueByPutCoinsUnder(bool bCoinOwner, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByPutCoinsUnder), formatType, param);
            }
        }
