...
{
    class AppendValueByCoinTotalSizeOver : AppendValueByCount
    {
        public AppendValueByCoinTotalSizeOver(bool bCoinOwner, Defines.CoinPosition coinPosition, int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinTotalSizeOver), formatType, param);
            }
        }
