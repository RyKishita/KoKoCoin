...
{
    class AppendValueByCoinNumCompareUnder : AppendValueByCount
    {
        public AppendValueByCoinNumCompareUnder(Defines.CoinPosition coinPosition, int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinNumCompareUnder), formatType, param);
            }
        }
