...
{
    class AppendValueBySameAreaUnder : AppendValueByCount
    {
        public AppendValueBySameAreaUnder(bool bCoinOwner, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueBySameAreaUnder), formatType, param);
            }
        }
