...
{
    class AddValueStatusByResourceEqual : AddValueStatusBy
    {
        public AddValueStatusByResourceEqual(int value, bool bCoinOwner, int num)
            : base(value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AddValueStatusByResourceEqual), formatType, param);
            }
        }
