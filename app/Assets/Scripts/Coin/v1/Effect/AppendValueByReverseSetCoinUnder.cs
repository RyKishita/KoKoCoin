...
{
    class AppendValueByReverseSetCoinUnder : AppendValueByCount
    {
        public AppendValueByReverseSetCoinUnder(bool bCoinOwner, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByReverseSetCoinUnder), formatType, param);
            }
        }
