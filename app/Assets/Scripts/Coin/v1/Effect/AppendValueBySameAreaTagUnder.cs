...
{
    class AppendValueBySameAreaTagUnder : AppendValueByCount
    {
        public AppendValueBySameAreaTagUnder(bool bCoinOwner, Defines.CoinTag coinTag, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueBySameAreaTagUnder), formatType, param);
            }
        }
