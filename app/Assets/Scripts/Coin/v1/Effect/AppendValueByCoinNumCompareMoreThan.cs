...
{
    class AppendValueByCoinNumCompareMoreThan : AppendValueByCount
    {
        public AppendValueByCoinNumCompareMoreThan(Defines.CoinPosition coinPosition, int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinNumCompareMoreThan), formatType, param);
            }
        }
