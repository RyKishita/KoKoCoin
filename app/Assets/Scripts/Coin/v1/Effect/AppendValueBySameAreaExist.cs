...
{
    class AppendValueBySameAreaExist : AppendValueByCount
    {
        public AppendValueBySameAreaExist(bool bCoinOwner, int value)
            : base(1, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueBySameAreaExist), formatType, param);
            }
        }
