...
{
    class AppendValueByTurnOver : AppendValueByCount
    {
        public AppendValueByTurnOver(Defines.CoinPosition coinPosition, int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByTurnOver), formatType, param);
            }
        }
