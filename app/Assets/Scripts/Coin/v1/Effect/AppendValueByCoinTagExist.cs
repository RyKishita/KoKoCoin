...
{
    class AppendValueByCoinTagExist : AppendValueByCount
    {
        public AppendValueByCoinTagExist(bool bCoinOwner, Defines.CoinPosition coinPosition, Defines.CoinTag coinTag, int value)
            : base(1, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinTagExist), formatType, param);
            }
        }
