...
{
    class AppendValueBySameAreaTagNotExist : AppendValueByCount
    {
        public AppendValueBySameAreaTagNotExist(bool bCoinOwner, Defines.CoinTag coinTag, int value)
            : base(0, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueBySameAreaTagNotExist), formatType, param);
            }
        }
