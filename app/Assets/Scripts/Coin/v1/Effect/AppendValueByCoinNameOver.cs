...
{
    class AppendValueByCoinNameOver : AppendValueByCount
    {
        public AppendValueByCoinNameOver(bool bCoinOwner, Defines.CoinPosition coinPosition, string coinName, int num, int value)
            : base(num, value)
        {
            if (coinPosition == Defines.CoinPosition.Field) throw new ArgumentException("AppendValueByCoinNameOverInField を使う");
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinNameOver), formatType, param);
            }
        }
