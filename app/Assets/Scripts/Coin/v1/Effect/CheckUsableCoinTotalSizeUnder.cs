...
{
    class CheckUsableCoinTotalSizeUnder : Assets.Scripts.Coin.Effect.Core, Scripts.Coin.Effect.IEffectUsable
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public CheckUsableCoinTotalSizeUnder(bool? bCoinOwner, Defines.CoinPosition coinPosition, int size)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(CheckUsableCoinTotalSizeUnder), formatType, param);
            }
        }
