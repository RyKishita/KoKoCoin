...
{
    class AppendValuesByCoinNumCompare : AppendValuesByCount
    {
        public AppendValuesByCoinNumCompare(Defines.CoinPosition coinPosition, int value)
            : base(value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValuesByCoinNumCompare), format, param);
            }
        }
        ...
        protected override int GetCount(DuelData duelData, SelectedCoinData selectedCoinData, int baseValue)
        {
            ...
            return Math.Max(0, numOwner - numOther);
        }
    }
}
