...
{
    class AppendValueBySameAreaTagOver : AppendValueByCount
    {
        public AppendValueBySameAreaTagOver(bool bCoinOwner, Defines.CoinTag coinTag, int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueBySameAreaTagOver), formatType, param);
            }
        }
