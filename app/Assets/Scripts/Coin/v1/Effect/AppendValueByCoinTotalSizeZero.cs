...
{
    class AppendValueByCoinTotalSizeZero : AppendValueByCount
    {
        public AppendValueByCoinTotalSizeZero(bool bCoinOwner, Defines.CoinPosition coinPosition, int value)
            : base(0, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinTotalSizeZero), formatType, param);
            }
        }
