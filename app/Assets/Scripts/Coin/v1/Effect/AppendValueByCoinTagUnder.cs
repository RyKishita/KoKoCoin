...
{
    class AppendValueByCoinTagUnder : AppendValueByCount
    {
        public AppendValueByCoinTagUnder(bool bCoinOwner, Defines.CoinPosition coinPosition, Defines.CoinTag coinTag, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinTagUnder), formatType, param);
            }
        }
