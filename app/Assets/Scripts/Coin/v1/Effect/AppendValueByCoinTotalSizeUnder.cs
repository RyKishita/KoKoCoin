...
{
    class AppendValueByCoinTotalSizeUnder : AppendValueByCount
    {
        public AppendValueByCoinTotalSizeUnder(bool bCoinOwner, Defines.CoinPosition coinPosition, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinTotalSizeUnder), formatType, param);
            }
        }
