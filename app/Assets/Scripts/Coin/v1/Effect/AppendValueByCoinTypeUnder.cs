...
{
    class AppendValueByCoinTypeUnder : AppendValueByCount
    {
        public AppendValueByCoinTypeUnder(bool bCoinOwner, Defines.CoinPosition coinPosition, Defines.CoinType selectCoinType, int num, int value)
            : base(-num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinTypeUnder), formatType, param);
            }
        }
