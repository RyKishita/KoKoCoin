...
{
    class AppendValueByDiffOwnerSetCoinOver : AppendValueByCount
    {
        public AppendValueByDiffOwnerSetCoinOver(int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByDiffOwnerSetCoinOver), formatType, param);
            }
        }
