...
{
    class AppendValueByCoinNumCompareLessThan : AppendValueByCount
    {
        public AppendValueByCoinNumCompareLessThan(Defines.CoinPosition coinPosition, int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueByCoinNumCompareLessThan), formatType, param);
            }
        }
