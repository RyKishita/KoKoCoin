...
{
    class AppendValueBySameAreaOver : AppendValueByCount
    {
        public AppendValueBySameAreaOver(bool bCoinOwner, int num, int value)
            : base(num, value)
        {
        ...
        public override string Explain
        {
            get
            {
                ...
                return GetEffectLocalizedString(nameof(AppendValueBySameAreaOver), formatType, param);
            }
        }
