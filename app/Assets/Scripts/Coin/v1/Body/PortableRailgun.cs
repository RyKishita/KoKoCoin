...
{
    class PortableRailgun : Scripts.Coin.Body.DirectAttack.Core
    {
        public PortableRailgun(string coinName)
            : base(coinName)
        {
        ...
        public override Scripts.Coin.Body.DirectAttack.IRange Range { get; } = new Scripts.Coin.Body.DirectAttack.RangeAny(6, 7, 8, 9, 10, 11, 12);
